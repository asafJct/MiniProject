...
namespace DAL
{
    public class Dal_imp : Idal
    {
        ...
        public IEnumerable<BE.Tester> getAllTesters(Func<BE.Tester, bool> predicat = null)
        {
       ...
       public IEnumerable<BE.Trainee> getAllTrainees(Func<BE.Trainee, bool> predicat = null)
        {//נבחנים
        ...
        {
            if (findTrainee(t.studentId))
                DataSource.l2.RemoveAll(d => d.id == t.studentId);
            else
       ...
       public  IEnumerable<BE.Test> getAllTests(Func<BE.Test, bool> predicat = null)
        {
